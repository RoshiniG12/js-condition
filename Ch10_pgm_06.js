...
var guess = getGuesser(20, 10); // Example range and offset
...
// Example usage
console.log(guess(15)); // Try guessing a number within the range and offset
console.log(guess(25)); // Try guessing another number within the range and offset
console.log(guess(30)); // Try guessing another number within the range and offset
